...
- **Agencija za zaštitu osobnih podataka — pravilo ISPRAVLJENO nakon revizije**: službeni hrvatski naziv AZOP-a ostaje na hrvatskom u OBA jezika (DE i EN), s prijevodom u zagradi — format: "Agencija za zaštitu osobnih podataka (Agentur für den Schutz personenbezogener Daten)" / "Agencija za zaštitu osobnih podataka (Croatian Personal Data Protection Agency)". Razlog: čitatelj koji se želi žaliti mora znati pravi naziv tijela da bi ga pronašao — prevedeni naziv ne pomaže u pretrazi. Primijenjeno dosljedno na sva 3 mjesta gdje se naziv pojavljuje (prozna rečenica u točki 7, adresni blok u točki 7, i lista prava u točki 4 — potonje mjesto je prije bilo samo s prijevodom, bez hrvatskog naziva, u OBA jezika, ispravljeno u oba). EN je prije ove ispravke imao SAMO prijevod ("Croatian Personal Data Protection Agency") posvuda, uključujući adresni blok/letterhead — ispravljeno da uključi i hrvatski naziv. DE je već imao hrvatski naziv u proznoj rečenici i adresnom bloku, ali ne i u točki 4 — dodano. Provjereno da nema drugih imenovanih hrvatskih institucija/sudova/registara u pravnim stranicama koje bi trebale isti tretman — "trgovački sud" (Handelsgericht/Commercial Court) je generički tip suda vezan uz mjesto (Varaždin), ne jedinstven naziv institucije koji čitatelj mora pretraživati, pa prijevod ostaje ispravan bez hrvatskog izraza u zagradi
